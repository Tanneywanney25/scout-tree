...
import { refreshChesscomCookie } from "../supabase/functions/_shared/chessCookie.ts";

// Minimal structural types so we don't depend on @vercel/node at type-check time
// (Vercel injects the real request/response at runtime).
interface Req {
  method?: string;
